...
- (id)init
{
    if(self = [super init]){
        ...
        SKTexture* birdTexture1 = [SKTexture textureWithImageNamed:@"joe_1"];
        birdTexture1.filteringMode = SKTextureFilteringNearest;
        SKTexture* birdTexture2 = [SKTexture textureWithImageNamed:@"joe_2"];
        birdTexture2.filteringMode = SKTextureFilteringNearest;
        SKTexture* birdTexture3 = [SKTexture textureWithImageNamed:@"joe_3"];
        birdTexture2.filteringMode = SKTextureFilteringNearest;
